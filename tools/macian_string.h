...
int32_t core_strdup(eiot_sysdep_portfile_t *sysdep, char **dest, char *src, char *module_name);
int32_t core_sprintf(eiot_sysdep_portfile_t *sysdep, char **dest, char *fmt, char *src[], uint8_t count,
                     char *module_name);
...
int32_t core_strcat(eiot_sysdep_portfile_t *sysdep, char **dest, char *src1, char *src2, char *module_name);
