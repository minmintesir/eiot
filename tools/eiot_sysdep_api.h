...
#ifndef _EIOT_SYSDEP_API_H_
#define _EIOT_SYSDEP_API_H_
...
typedef enum {
    EIOT_SYSDEP_NETWORK_CRED_NONE,
    EIOT_SYSDEP_NETWORK_CRED_SVRCERT_CA,
    EIOT_SYSDEP_NETWORK_CRED_SVRCERT_PSK,
    EIOT_SYSDEP_NETWORK_CRED_MAX
} eiot_sysdep_network_cred_option_t;

typedef struct {
    eiot_sysdep_network_cred_option_t option;  /* 安全策略 */
...
typedef enum {
    ...
    CORE_SYSDEP_NETWORK_CRED,                    /* 用于设置网络层安全参数  数据类型: (eiot_sysdep_network_cred_t *) */
...
} eiot_sysdep_portfile_t;

void eiot_sysdep_set_portfile(eiot_sysdep_portfile_t *portfile);
eiot_sysdep_portfile_t *eiot_sysdep_get_portfile(void);
